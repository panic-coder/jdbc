...
public class CrudOperationsPreparedStatement {
				...
				while(loopOperations==0) {
					...
					case 2:
						...
						while(loopUpdates==0) {
							...
							case 1:
								utility.displayPrepared(databaseName);
								break;
							case 2:
								Info info = new Info();
								...
								utility.insertPrepared(info,databaseName);
								break;
							case 3:
								utility.deletePrepared(databaseName);
								break;
							case 4:
								utility.updatePrepared(databaseName);
								break;
							case 5:
								loopUpdates=1;
